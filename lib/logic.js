...
async function dummyData(tx) {
    ...
    farmer.actorLocation = 'Shipper Location';
    ...
    farmer.actorLocation = 'Warehouseman Location';
    ...
    farmer.actorLocation = 'Distributor Location';
    ...
    farmer.actorLocation = 'Retailer Location';
