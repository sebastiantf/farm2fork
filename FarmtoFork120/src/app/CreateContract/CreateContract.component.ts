...
export class CreateContractComponent implements OnInit {
  ...
  promisedNoOfDays = new FormControl('', Validators.required);
  ...
  constructor(private serviceCreateContract: CreateContractService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      promisedNoOfDays: this.promisedNoOfDays,
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      ...
      'promisedNoOfDays': this.promisedNoOfDays.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.promisedNoOfDays) {
        formObject.promisedNoOfDays = result.promisedNoOfDays;
      } else {
        formObject.promisedNoOfDays = null;
      }
