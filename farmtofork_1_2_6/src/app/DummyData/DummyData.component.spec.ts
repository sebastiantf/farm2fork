...
describe('DummyDataComponent', () => {
  ...
  let mockDummyDataService;
  let mockDataService

  beforeEach(async(() => {

    mockDummyDataService = sinon.createStubInstance(DummyDataService);
    mockDummyDataService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: DummyDataService, useValue: mockDummyDataService },
